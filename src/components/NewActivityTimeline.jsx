...
import './NewActivityTimeline.css';
...
const NewActivityTimeline = ({ activityData }) => {
  // Debug: Log the data
  console.log('NewActivityTimeline received data:', activityData);
  console.log('NewActivityTimeline data length:', activityData?.length);
  console.log('NewActivityTimeline data type:', typeof activityData);
  console.log('NewActivityTimeline is array:', Array.isArray(activityData));
...
export default NewActivityTimeline;
